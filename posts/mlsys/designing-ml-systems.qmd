---
title: "The Production ML Survival Guide"
subtitle: "What I Learned Deploying Models That Serve Millions While Others Failed at Launch"
...
![](images/mlsys.svg){height="500" width="800"}
...
![Figure 1: Throughput vs latency trade-off](images/throughput-vs-latency.svg)
...
![Figure 2: Mapping ml metrics to buisiness metrics](images/ml-to-business-metrics.svg)
...
![Figure 3: Data types](images/data-types-characteristics.svg)
...
![Figure 4: Sampling strategy selection](images/sampling-strategy.svg)
...
<!--         C[Engagement]:::engagement --> D["Volume: Medium\nDelay: Minutes\nNoise: Medium"]:::card -->
<!--         E[Explicit]:::explicit --> F["Volume: Low\nDelay: Days\nNoise: Low"]:::card -->
<!---->
<!--         G["Fast Learning\nLow Quality"] -.-> A -->
<!--         H["Slow Learning\nHigh Quality"] -.-> E -->
<!--     end -->
<!---->
<!--     classDef implicit fill:#dbeafe,stroke:#2563eb,stroke-width:2px,color:#1e3a8a,font-weight:bold; -->
<!--     classDef engagement fill:#fef3c7,stroke:#d97706,stroke-width:2px,color:#92400e,font-weight:bold; -->
<!--     classDef explicit fill:#dcfce7,stroke:#15803d,stroke-width:2px,color:#065f46,font-weight:bold; -->
<!--     classDef card fill:#ffffff,stroke:#94a3b8,stroke-dasharray:3 3,rx:10,ry:10; -->
<!-- ``` -->
```{mermaid}
graph TD
...
![Figure 5: Class imbalance solutions by severity](images/class-imbalance.svg)
...
![Figure 6: Handling missing values](images/missing-values.svg)
...
![Figure 7: Data leakage detection](images/data-leakage.svg)
...
![Figure 8: ML monitoring stack](images/monitoring.svg)
...
![Figure 9: Distribution shift types](images/distribution-shift.svg)
...
![Figure 10: Production testing](images/production-testing.svg)
