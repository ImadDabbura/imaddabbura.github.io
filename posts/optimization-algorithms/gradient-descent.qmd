...
subtitle: "Deep dive into gradient descent algorithm: Batch vs. Mini-batch vs. Stochastic."
image: "images/gradient_cover.PNG"
date: "2019-02-18"
categories: ["Software Development", "Virtual Environments"]
---

![](images/gradient_cover.PNG){.preview-image}
...
![**Figure 1**: Gradient descent with different learning rates [Source](http://cs231n.github.io/neural-networks-3/)](images/learning_rate.PNG){fig-align="left" width="600" height="400"}

* The most commonly used rates are : *0.001, 0.003, 0.01, 0.03, 0.1, 0.3*.
3. Make sure to scale the data if it's on very different scales. If we don't scale the data, the level curves (contours) would be narrower and taller which means it would take longer time to converge (see figure 2).

![**Figure 2**: Gradient descent: normalized versus unnormalized level curves](images/normalized-vs-unnormalized.PNG){fig-align="left" width="800" height="300"}
...
![**Figure 3**: Gradient descent. An illustration of how gradient descent algorithm uses the first derivative of the loss function to follow downhill it’s minimum.](images/gradients.PNG){fig-align="left" width="600" height="400"}
...
![**Figure 4**: Gradient descent: batch versus mini-batch loss function](images/batch-vs-minibatch.PNG){fig-align="left" width="800" height="300"}
...
![**Figure 5**: Gradient descent variants' trajectory towards minimum](images/batch-vs-minibatch-vs-stochastic.PNG){fig-align="left" width="600" height="300"}
...
![**Figure 6**: Gradient descent fails to exploit the curvature information contained in the Hessian matrix. [Source](http://www.deeplearningbook.org/contents/numerical.html)](images/curvature.PNG){fig-align="left" width=400" height="400"}
...
![**Figure 7**: Gradient norm. [Source](http://www.deeplearningbook.org/contents/optimization.html)](images/gradient_norm.PNG){fig-align="left" width="600" height="300"}
...
![**Figure 8**: Saddle point](images/saddle.PNG){fig-align="left" width="600" height="300"}
