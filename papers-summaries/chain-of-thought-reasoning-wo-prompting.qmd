...
- **Notes**:
    - LLM reasoning are typically elicited by prompting the comes in various
    forms:
    ...
    the LLM in the answer in very high
        - The answer's confidence is the average between top two tokens
        probability
    ...
    - Branching at the first-token leads to more divers paths as opposed to
    ...
    the best paths may be start at lower `k`, but for instruction-tuned models
