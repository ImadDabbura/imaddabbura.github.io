...
date: 2023-11-16
description: "Unified text-to-text framework using encoder-decoder architecture, converting any NLP task into the same format with the same model, objective, and decoding."
categories:
status: evergreen
  - Foundational Models
---
