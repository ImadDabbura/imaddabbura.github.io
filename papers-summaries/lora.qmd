...
date: 2022-06-11
description: "Low-rank decomposition matrices for transformer attention weights — minimal trainable parameters, no inference latency overhead, efficient task switching."
categories:
status: evergreen
