...
date: 2024-04-01
description: "End-to-end pre-training of retriever and language model together, augmenting LM with external knowledge for improved downstream performance."
categories:
status: evergreen
  - Retrieval & RAG
---
