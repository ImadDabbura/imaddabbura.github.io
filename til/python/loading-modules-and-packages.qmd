...
As a result, if a module is imported in different modules in the sample
application, it would be imported ONLY once. This is very useful for config
files that sets up application's configuration such as loggers. Importing the
configuration module in many places would only lead to executing the module
once.
