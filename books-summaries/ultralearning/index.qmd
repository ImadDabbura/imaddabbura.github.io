...
7. **RETENTION: DON’T FILL A LEAKY BUCKET**. Understand what you forget and why. Learn to remember things not just for now but forever.
	...
	3. Mechanisms:
		1. *Spaced repetition*: There is a trade-off between the number of intervals and gap between intervals. The longer the periods between intervals -> the more weight the short term effect would have, which may lead to forgetting what was learned in the previous session. Therefore, pick the pace where you get the best out of both.
...
8. **INTUITION: DIG DEEP BEFORE BUILDING UP**. Develop your intuition through play and exploration of concepts and skills. Understand how things work, and don’t recourse to cheap tricks of memorization to avoid deeply knowing things.
